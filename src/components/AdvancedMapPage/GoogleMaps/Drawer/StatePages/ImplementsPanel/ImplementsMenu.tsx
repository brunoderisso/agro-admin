...
import useStyles from "../../../../../../styles/AdvancedMapPage/GoogleMaps/ImplementsMenu"
...
ImplementsMenu.propTypes = {
  onChange: PropTypes.func,
  value: PropTypes.number
}

export default ImplementsMenu