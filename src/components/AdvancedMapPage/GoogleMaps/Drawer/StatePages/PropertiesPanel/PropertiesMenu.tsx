...
import useStyles from "../../../../../../styles/AdvancedMapPage/GoogleMaps/PropertiesMenu"
...
function PropertiesMenu(props) {
  ...
  return (
    <AppBar id="appBarId" position="static" color="default">
      ...
      >
        {/* TODO: Segunda fase */}
        {/* <Tab style={{ borderRight: "solid 1px" + theme.colors.inactive }} label="Cultivar" {...a11yProps(0)} /> */}
