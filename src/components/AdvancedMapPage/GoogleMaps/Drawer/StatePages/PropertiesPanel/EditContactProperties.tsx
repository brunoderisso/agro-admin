...
import useStyles from "../../../../../../styles/AdvancedMapPage/GoogleMaps/EditContactProperties"
      ...
      <Grid>
        ...
        <Grid className={classes.containerBoxUser}>
          <Typography className={classes.propertyDescriptionEdit}>
            <AccountBoxIcon style={{ color: "#1C1B1F" }} fontSize="small" />
            Esse é o contato principal dessa propriedade
          </Typography>
