...
import Document from "../../../../../../img/AdvancedMapIcons/Document.svg?react"
import Visit from "../../../../../../img/AdvancedMapIcons/Visit.svg?react"
import AllDoccument from "../../../../../../img/AdvancedMapIcons/AllDoccument.svg?react"
import useStyles from "../../../../../../styles/AdvancedMapPage/GoogleMaps/NewAnnotation"
...
const NewAnnotation = (props) => {
  ...
  const [valueMultiline, setValueMultiline] = useState<string>("Cliente solicitou uma visita em conversa por telefone comigo.")
          ...
          >
            ...
            <Grid item xs={12}>
              <Typography variant="caption">
                {!toolsUtils.isEmptyString(fileName)
                  ? fileName
                  : "Arraste e solte ou clique para carregar imagens(Somente arquivos JPG e PNG de até 2 MB)"
                }
              </Typography>
            </Grid>
          </Paper>
